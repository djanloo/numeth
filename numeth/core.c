...
struct __pyx_opt_args_4core_harmosc;
...
static float __pyx_f_4core_randelta(void); /*proto*/
static float __pyx_f_4core_randzerone(void); /*proto*/
static PyObject *__pyx_f_4core_harmosc(__Pyx_memviewslice, float, int, int __pyx_skip_dispatch, struct __pyx_opt_args_4core_harmosc *__pyx_optional_args); /*proto*/
static PyObject *__pyx_f_4core_dummy_last(__Pyx_memviewslice, float, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_4core_dummy_last_2(__Pyx_memviewslice, float, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_4core_dummy_no_memviews(float, int __pyx_skip_dispatch); /*proto*/
...
static const char __pyx_k_Module_for_core_calculations[] = "Module for core calculations";
...
static PyObject *__pyx_pf_4core_harmosc(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_eps, int __pyx_v_refresh, float __pyx_v_eta); /* proto */
static PyObject *__pyx_pf_4core_2dummy_last(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_eps, int __pyx_v_refresh); /* proto */
static PyObject *__pyx_pf_4core_4dummy_last_2(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_eps, int __pyx_v_refresh); /* proto */
static PyObject *__pyx_pf_4core_6dummy_no_memviews(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_x); /* proto */
...
static float __pyx_f_4core_randelta(void) {
  float __pyx_r;
  int __pyx_t_1;
  int __pyx_lineno = 0;
 ...
 */
  ...
  __pyx_r = (2.0 * ((((double)__pyx_t_1) / ((double)INT_MAX)) - 0.5));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("core.randelta", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static float __pyx_f_4core_randzerone(void) {
  float __pyx_r;
  int __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("core.randzerone", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static PyObject *__pyx_pw_4core_1harmosc(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4core_harmosc(__Pyx_memviewslice __pyx_v_x, float __pyx_v_eps, int __pyx_v_refresh, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_4core_harmosc *__pyx_optional_args) {
  float __pyx_v_eta = ((float)0.1);
  int __pyx_v_N;
  int __pyx_v_k;
  float __pyx_v_proposal;
  float __pyx_v_log_r;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("harmosc", 0);
 ...
 */
          ...
          if ((1 == 0)) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel private(__pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_8, __pyx_t_9) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      #ifdef WITH_THREAD
                      ...
                      #endif /* _OPENMP */
                      #ifdef _OPENMP
                      #pragma omp for firstprivate(__pyx_v_k) lastprivate(__pyx_v_k) lastprivate(__pyx_v_log_r) lastprivate(__pyx_v_proposal)
                      #endif /* _OPENMP */
                      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                          if (__pyx_parallel_why < 2)
                          {
                              ...
                              __pyx_v_log_r = ((float)__PYX_NAN());
                              __pyx_v_proposal = ((float)__PYX_NAN());
 ...
 */
                              ...
                              __pyx_v_proposal = ((*((float *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_8 * __pyx_v_x.strides[0]) ))) + (__pyx_v_eps * __pyx_f_4core_randelta()));
 ...
 */
                              ...
                              __pyx_t_14 = __Pyx_mod_long(__pyx_t_13, __pyx_v_N);
                              if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_x.shape[0];
                              __pyx_v_log_r = (((-((__pyx_v_proposal * __pyx_v_proposal) - ((*((float *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_8 * __pyx_v_x.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_9 * __pyx_v_x.strides[0]) )))))) * ((1.0 / ((double)__pyx_v_eta)) + (((double)__pyx_v_eta) / 2.0))) + (((1.0 / ((double)__pyx_v_eta)) * (__pyx_v_proposal - (*((float *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_10 * __pyx_v_x.strides[0]) ))))) * ((*((float *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_12 * __pyx_v_x.strides[0]) ))) + (*((float *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_14 * __pyx_v_x.strides[0]) ))))));
 ...
 *   return x
 */
                              __pyx_t_15 = ((__pyx_v_log_r > log(__pyx_f_4core_randzerone())) != 0);
                              if (__pyx_t_15) {
 ...
 */
                                ...
                                if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_x.shape[0];
                                *((float *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_14 * __pyx_v_x.strides[0]) )) = __pyx_v_proposal;
 ...
 */
                              ...
                              #endif /* _OPENMP */
                              {
                                  ...
                                  __pyx_parallel_temp1 = __pyx_v_log_r;
                                  __pyx_parallel_temp2 = __pyx_v_proposal;
                              }
                              __pyx_L16:;
                              #ifdef _OPENMP
                      ...
                      #else
{
              ...
              if (__pyx_parallel_why) {
                ...
                __pyx_v_log_r = __pyx_parallel_temp1;
                __pyx_v_proposal = __pyx_parallel_temp2;
 ...
 */
  ...
  __pyx_t_16 = __pyx_memoryview_fromslice(__pyx_v_x, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 32, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("core.harmosc", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_4core_1harmosc(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4core_harmosc[] = "Commento a caso";
static PyObject *__pyx_pw_4core_1harmosc(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("harmosc (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_eps,&__pyx_n_s_refresh,&__pyx_n_s_eta,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_eps)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("harmosc", 0, 3, 4, 1); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_refresh)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("harmosc", 0, 3, 4, 2); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "harmosc") < 0)) __PYX_ERR(0, 17, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_eps = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_eps == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_refresh = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_refresh == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_eta = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_eta == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("harmosc", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 17, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("core.harmosc", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4core_harmosc(__pyx_self, __pyx_v_x, __pyx_v_eps, __pyx_v_refresh, __pyx_v_eta);
...
static PyObject *__pyx_pf_4core_harmosc(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_eps, int __pyx_v_refresh, float __pyx_v_eta) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_4core_harmosc __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("harmosc", 0);
  ...
  __pyx_t_1 = __pyx_f_4core_harmosc(__pyx_v_x, __pyx_v_eps, __pyx_v_refresh, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
...
static PyObject *__pyx_pw_4core_3dummy_last(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4core_dummy_last(CYTHON_UNUSED __Pyx_memviewslice __pyx_v_x, CYTHON_UNUSED float __pyx_v_eps, CYTHON_UNUSED int __pyx_v_refresh, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dummy_last", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_4core_3dummy_last(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4core_3dummy_last(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_eps;
  int __pyx_v_refresh;
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dummy_last (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_eps,&__pyx_n_s_refresh,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_eps)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("dummy_last", 1, 3, 3, 1); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_refresh)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dummy_last", 1, 3, 3, 2); __PYX_ERR(0, 34, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "dummy_last") < 0)) __PYX_ERR(0, 34, __pyx_L3_error)
      }
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_eps = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_eps == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_refresh = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_refresh == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 34, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("dummy_last", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 34, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("core.dummy_last", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4core_2dummy_last(__pyx_self, __pyx_v_x, __pyx_v_eps, __pyx_v_refresh);
...
static PyObject *__pyx_pf_4core_2dummy_last(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_eps, int __pyx_v_refresh) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_t_1 = __pyx_f_4core_dummy_last(__pyx_v_x, __pyx_v_eps, __pyx_v_refresh, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_4core_5dummy_last_2(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4core_dummy_last_2(CYTHON_UNUSED __Pyx_memviewslice __pyx_v_x, CYTHON_UNUSED float __pyx_v_eps, CYTHON_UNUSED int __pyx_v_refresh, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dummy_last_2", 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_4core_5dummy_last_2(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4core_5dummy_last_2(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_eps;
  int __pyx_v_refresh;
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dummy_last_2 (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_eps,&__pyx_n_s_refresh,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_eps)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("dummy_last_2", 1, 3, 3, 1); __PYX_ERR(0, 37, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_refresh)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("dummy_last_2", 1, 3, 3, 2); __PYX_ERR(0, 37, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "dummy_last_2") < 0)) __PYX_ERR(0, 37, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 37, __pyx_L3_error)
    __pyx_v_eps = __pyx_PyFloat_AsFloat(values[1]); if (unlikely((__pyx_v_eps == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L3_error)
    __pyx_v_refresh = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_refresh == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("dummy_last_2", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 37, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("core.dummy_last_2", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4core_4dummy_last_2(__pyx_self, __pyx_v_x, __pyx_v_eps, __pyx_v_refresh);
...
static PyObject *__pyx_pf_4core_4dummy_last_2(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, float __pyx_v_eps, int __pyx_v_refresh) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("dummy_last_2", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_x.memview)) { __Pyx_RaiseUnboundLocalError("x"); __PYX_ERR(0, 37, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_4core_dummy_last_2(__pyx_v_x, __pyx_v_eps, __pyx_v_refresh, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_4core_7dummy_no_memviews(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_f_4core_dummy_no_memviews(float __pyx_v_x, CYTHON_UNUSED int __pyx_skip_dispatch) {
  CYTHON_UNUSED int __pyx_v_i;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("dummy_no_memviews", 0);
 ...
 *   return x
 */
    __pyx_v_x = (__pyx_v_x + __pyx_f_4core_randzerone());
  }
 ...
 */
  ...
  __Pyx_AddTraceback("core.dummy_no_memviews", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_4core_7dummy_no_memviews(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyObject *__pyx_pw_4core_7dummy_no_memviews(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  float __pyx_v_x;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dummy_no_memviews (wrapper)", 0);
  assert(__pyx_arg_x); {
    __pyx_v_x = __pyx_PyFloat_AsFloat(__pyx_arg_x); if (unlikely((__pyx_v_x == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 40, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("core.dummy_no_memviews", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4core_6dummy_no_memviews(__pyx_self, ((float)__pyx_v_x));
...
static PyObject *__pyx_pf_4core_6dummy_no_memviews(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_x) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("dummy_no_memviews", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4core_dummy_no_memviews(__pyx_v_x, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"harmosc", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4core_1harmosc, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4core_harmosc},
  {"dummy_last", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4core_3dummy_last, METH_VARARGS|METH_KEYWORDS, 0},
  {"dummy_last_2", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4core_5dummy_last_2, METH_VARARGS|METH_KEYWORDS, 0},
  {"dummy_no_memviews", (PyCFunction)__pyx_pw_4core_7dummy_no_memviews, METH_O, 0},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "core",
    __pyx_k_Module_for_core_calculations, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("core", __pyx_methods, __pyx_k_Module_for_core_calculations, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
